...
export const academicKeys = {
  ...
  academicYearCurrent: () => [...academicKeys.academicYears(), 'current'] as const,
  ...
  assessmentType: (id: string) => [...academicKeys.assessmentTypes(), id] as const,
  ...
  termTypeTerms: (id: string) => [...academicKeys.termType(id), 'terms'] as const,
...
export const geographyKeys = {
  ...
  administrativeUnits: () => [...geographyKeys.all, 'administrative-units'] as const,
  administrativeUnitsList: (filters?: Record<string, any>) => 
    [...geographyKeys.administrativeUnits(), 'list', filters] as const,
  administrativeUnit: (id: string) => [...geographyKeys.administrativeUnits(), id] as const,
