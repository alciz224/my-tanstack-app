...
export const ACADEMIC_ENDPOINTS = {
  ...
  ACADEMIC_YEAR_DETAIL: (id: string) => `/api/v1/academic/academic-years/${id}/`,
  ACADEMIC_YEAR_ACTIVATE: (id: string) => `/api/v1/academic/academic-years/${id}/activate/`,
  ACADEMIC_YEAR_ARCHIVE: (id: string) => `/api/v1/academic/academic-years/${id}/archive/`,
  ACADEMIC_YEAR_SET_CURRENT: (id: string) => `/api/v1/academic/academic-years/${id}/set_current/`,
  ...
  ASSESSMENT_TYPE_DETAIL: (id: string) => `/api/v1/academic/assessment-types/${id}/`,
...
export const GEOGRAPHY_ENDPOINTS = {
  ...
  ADMINISTRATIVE_UNIT_DETAIL: (id: string) => `/api/v1/administrative-units/${id}/`,
...
export const SCHOOL_OPERATIONS_ENDPOINTS = {
  ...
  SCHOOL_YEAR_DETAIL: (id: string) => `/api/v1/school-operations/school-years/${id}/`,
  ...
  SCHOOL_YEARS_BY_SCHOOL: (schoolId: string) => `/api/v1/school-operations/school-years/by-school/${schoolId}/`,
  SCHOOL_YEARS_BY_ACADEMIC_YEAR: (academicYearId: string) => `/api/v1/school-operations/school-years/by-academic-year/${academicYearId}/`,

  // School Year Cycles
  SCHOOL_YEAR_CYCLES: '/api/v1/school-operations/school-year-cycles/',
  SCHOOL_YEAR_CYCLE_DETAIL: (id: string) => `/api/v1/school-operations/school-year-cycles/${id}/`,

  // School Year Cycle Levels
  SCHOOL_YEAR_CYCLE_LEVELS: '/api/v1/school-operations/school-year-cycle-levels/',
  SCHOOL_YEAR_CYCLE_LEVEL_DETAIL: (id: string) => `/api/v1/school-operations/school-year-cycle-levels/${id}/`,

  // School Year Cycle Level Subjects
  SCHOOL_YEAR_CYCLE_LEVEL_SUBJECTS: '/api/v1/school-operations/school-year-cycle-level-subjects/',
  SCHOOL_YEAR_CYCLE_LEVEL_SUBJECT_DETAIL: (id: string) => `/api/v1/school-operations/school-year-cycle-level-subjects/${id}/`,

  // Time Slots
  TIME_SLOTS: '/api/v1/school-operations/time-slots/',
  TIME_SLOT_DETAIL: (id: string) => `/api/v1/school-operations/time-slots/${id}/`,

  // School Year Cycle Time Slots
  SCHOOL_YEAR_CYCLE_TIME_SLOTS: '/api/v1/school-operations/school-year-cycle-time-slots/',
  SCHOOL_YEAR_CYCLE_TIME_SLOT_DETAIL: (id: string) => `/api/v1/school-operations/school-year-cycle-time-slots/${id}/`,
...
export const ENROLLMENT_ENDPOINTS = {
  ...
  STUDENT_ENROLLMENT_DETAIL: (id: string) => `/api/v1/enrollment/student-enrollments/${id}/`,

  TEACHER_ASSIGNMENTS: '/api/v1/enrollment/teacher-assignments/',
  TEACHER_ASSIGNMENT_DETAIL: (id: string) => `/api/v1/enrollment/teacher-assignments/${id}/`,
} as const
...
export const ASSESSMENT_ENDPOINTS = {
  ...
  GRADING_SHEET_DETAIL: (id: string) => `/api/v1/assessment/grading-sheets/${id}/`,
