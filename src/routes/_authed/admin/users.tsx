      ...
      <div className="bg-card border border-border rounded-lg overflow-hidden shadow-sm hover-lift">
        ...
        <div className="p-4 border-t border-border flex items-center justify-between bg-muted/10">
          <span className="text-sm text-muted-foreground">
            Affichage de <span className="font-medium text-foreground">1</span>{' '}
            à <span className="font-medium text-foreground">5</span> sur{' '}
            <span className="font-medium text-foreground">42</span> utilisateurs
          </span>
