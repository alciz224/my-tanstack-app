  ...
  const features = [
    {
      ...
      description: 'Secure authentication with role-based access control and multi-factor verification.',
    },
    {
      icon: <Shield className="w-6 h-6 text-secondary" />,
      title: 'Enterprise Security',
      description: 'Industry-standard encryption, session management, and comprehensive audit trails.',
    },
    {
      icon: <Lock className="w-6 h-6 text-secondary" />,
      title: 'Data Privacy',
      description: 'GDPR-compliant data handling with secure storage and granular permissions.',
    },
  ]
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-10 md:py-12 px-6 max-w-7xl mx-auto">
        <div className="flex items-end justify-between gap-4 mb-5">
          <div>
            <h3 className="text-foreground text-2xl font-bold">Key Features</h3>
