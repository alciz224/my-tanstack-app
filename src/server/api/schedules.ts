...
export const getTimeSlotsFn = createServerFn({ method: 'GET' })
  ...
  .handler(
    async ({
      ...
      return (await import('@/server/data/schedules/factory')).getSchedulesService().getTimeSlots(schoolYearCycleId)
    },
  )
...
export const createTimeSlotFn = createServerFn({ method: 'POST' })
  ...
  .handler(async ({ data }): Promise<SchoolYearCycleTimeSlot> => {
    return (await import('@/server/data/schedules/factory')).getSchedulesService().createTimeSlot(data)
  })
...
export const updateTimeSlotFn = createServerFn({ method: 'POST' })
  ...
  .handler(
    async ({ data: { id, updates } }): Promise<SchoolYearCycleTimeSlot> => {
      return (await import('@/server/data/schedules/factory')).getSchedulesService().updateTimeSlot(id, updates)
    },
  )
...
export const deleteTimeSlotFn = createServerFn({ method: 'POST' })
  ...
  .handler(async ({ data: id }): Promise<void> => {
    return (await import('@/server/data/schedules/factory')).getSchedulesService().deleteTimeSlot(id)
  })
...
export const getClassroomScheduleFn = createServerFn({ method: 'GET' })
  ...
  .handler(async ({ data: classroomId }): Promise<Array<Schedule>> => {
    return (await import('@/server/data/schedules/factory')).getSchedulesService().getClassroomSchedule(classroomId)
  })
...
export const getTeacherScheduleFn = createServerFn({ method: 'GET' })
  ...
  .handler(async ({ data: teacherAssignmentId }): Promise<Array<Schedule>> => {
    return (await import('@/server/data/schedules/factory')).getSchedulesService().getTeacherSchedule(teacherAssignmentId)
  })
...
export const createScheduleBlockFn = createServerFn({ method: 'POST' })
  ...
  .handler(async ({ data }): Promise<Schedule> => {
    return (await import('@/server/data/schedules/factory')).getSchedulesService().createScheduleBlock(data)
  })
...
export const updateScheduleBlockFn = createServerFn({ method: 'POST' })
  ...
  .handler(async ({ data: { id, updates } }): Promise<Schedule> => {
    return (await import('@/server/data/schedules/factory')).getSchedulesService().updateScheduleBlock(id, updates)
  })

export const deleteScheduleBlockFn = createServerFn({ method: 'POST' })
  .inputValidator((id: string) => id)
  .handler(async ({ data: id }): Promise<void> => {
    return (await import('@/server/data/schedules/factory')).getSchedulesService().deleteScheduleBlock(id)
  })
