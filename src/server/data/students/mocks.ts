...
const LOCALITIES: Array<{ id: string; name: string }> = [
  { id: 'LOC-KAL-CEN', name: 'Conakry' },
  { id: 'LOC-KIN-CEN', name: 'Kindia' },
  { id: 'LOC-LAB-CEN', name: 'Labé' },
  { id: 'LOC-BOK-VIL', name: 'Boké' },
  { id: 'LOC-NZE-VIL', name: 'Nzérékoré' },
  { id: 'LOC-KAN-VIL', name: 'Kankan' },
  { id: 'LOC-MAM-CEN', name: 'Mamou' },
  { id: 'LOC-DAB-CEN', name: 'Dabola' },
  { id: 'LOC-SIG-CEN', name: 'Siguiri' },
  { id: 'LOC-FOR-CEN', name: 'Forécariah' },
  { id: 'LOC-TEL-CEN', name: 'Télimélé' },
  { id: 'LOC-GAU-CEN', name: 'Gaoual' },
  { id: 'LOC-KOU-CEN', name: 'Koundara' },
  { id: 'LOC-MAC-CEN', name: 'Macenta' },
  { id: 'LOC-MAC-CEN', name: 'Guéckédou' },
  { id: 'LOC-KIS-CEN', name: 'Kissidougou' },
]
  ...
  for (const classroom of config.classrooms) {
    ...
    for (let i = 0; i < maleCount; i++) {
      ...
      students.push({
        ...
        address: pick(ADDRESSES_BY_DISTRICT[locality.name] || [locality.name]),
...
export const MOCK_STUDENTS: Array<Student> = [
  {
    ...
    photo_url: null,
    birthplace_locality_id: 'LOC-KAL-CEN',
  ...
  },
  {
    ...
    photo_url: null,
    birthplace_locality_id: 'LOC-KIN-CEN',
  ...
  },
  {
    ...
    photo_url: null,
    birthplace_locality_id: 'LOC-LAB-CEN',
  ...
  },
  {
    ...
    photo_url: null,
    birthplace_locality_id: 'LOC-BOK-VIL',
  ...
  },
  {
    ...
    photo_url: null,
    birthplace_locality_id: 'LOC-NZE-VIL',
  ...
  },
  {
    ...
    photo_url: null,
    birthplace_locality_id: 'LOC-KAN-VIL',
