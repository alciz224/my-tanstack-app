...
const mockReportCards: Array<ReportCard> = [
  {
    ...
    line_items: [
      { id: 'li-1', subject_name: 'Mathématiques', coefficient: 3, score: 15.5, weighted_score: 46.5, teacher_name: 'M. Bah', appreciation: 'Très bon travail' },
      { id: 'li-2', subject_name: 'Français', coefficient: 3, score: 14.0, weighted_score: 42.0, teacher_name: 'Mme. Sylla', appreciation: 'Bon trimestre' },
      { id: 'li-3', subject_name: 'Anglais', coefficient: 2, score: 16.0, weighted_score: 32.0, teacher_name: 'M. Barry', appreciation: 'Excellent' },
      { id: 'li-4', subject_name: 'Histoire-Géo', coefficient: 2, score: 13.5, weighted_score: 27.0, teacher_name: 'M. Camara', appreciation: 'Assez bien' },
      { id: 'li-5', subject_name: 'Sciences', coefficient: 2, score: 14.0, weighted_score: 28.0, teacher_name: 'Mme. Touré', appreciation: 'En progrès' },
    ],
  },
  {
    id: 'rc-2',
