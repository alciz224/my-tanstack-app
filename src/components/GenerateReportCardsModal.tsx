        ...
        {success ? (
          <div className="p-8 text-center flex flex-col items-center justify-center space-y-4">
            ...
            <p className="text-muted-foreground">
              Les bulletins ont été générés avec succès pour la classe
              sélectionnée.
            </p>
          </div>
        ) : (
          <form onSubmit={handleGenerate} className="p-6 space-y-5">
            ...
            <div className="p-4 bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 rounded-lg flex gap-3 text-sm">
              ...
              <p className="text-blue-900 dark:text-blue-200">
                Assurez-vous que toutes les notes du trimestre sont{' '}
                <strong>saisies et validées</strong> avant de lancer la
                génération.
              </p>
            </div>
